...
class Pgtail < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "2a83027949ae343542837b221b6ff54e6f26d269c5668d75f9b000b9fe516be2"
    end
    on_intel do
      url "https://github.com/willibrandon/pgtail/releases/download/v#{version}/pgtail-macos-x86_64.tar.gz"
      sha256 "0a759ece1db253e46df6ed7635331a7b613a0d4bace8cc32b70791c572f69415"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "da12803cd3ffe93d3c90a15e5f9158c417031c64adc82cf4da7d77229519e687"
    end
    on_intel do
      url "https://github.com/willibrandon/pgtail/releases/download/v#{version}/pgtail-linux-x86_64.tar.gz"
      sha256 "342a3eee54e766ce14066258e4a75a196d55ecd33154802ff21ac6fedaf62f87"
    end
  end
