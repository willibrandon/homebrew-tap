...
class DotsiderMcp < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "8e9bfa28c433c39d04e27cf1ae6372350cd8f2da9f7745c51f87d96b756b9a94"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "8006192c865860df3c11fd6e834aacc5078bd24d55a06b54c94cb7044694d43e"
    end
    on_intel do
      url "https://github.com/willibrandon/dotsider/releases/download/v#{version}/dotsider-mcp-linux-x64.tar.gz"
      sha256 "a5776545b9caa51fe15aca4d59f208838ac865cb2b9f3107ba6bacf4d846c7d8"
    end
  end
