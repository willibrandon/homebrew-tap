...
class Chill < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "11a14f8fb826f0ba3b4e28bf58092e075b7123a96b75e8882569c22bd8676e0d"
    end
    on_intel do
      url "https://github.com/willibrandon/chill/releases/download/v#{version}/chill_#{version}_darwin_amd64.tar.gz"
      sha256 "ee19ba8810210c1e71e855d5d22ef9dbd009f0ad560676fc5178c15195382cf8"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "e1b77961d52bf45cb1e76deb86c09bde32af558aea20ad39ae556049642b3e3d"
    end
    on_intel do
      url "https://github.com/willibrandon/chill/releases/download/v#{version}/chill_#{version}_linux_amd64.tar.gz"
      sha256 "4c9ad25b71b6e262be7cbe2b744a3a63838d7d0b1e3d877423b38e4aee95bd1d"
    end
  end
